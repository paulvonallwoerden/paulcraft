...
import { CanvasTexture, ImageLoader, NearestFilter } from "three";
...
var TextureAtlas = /** @class */ (function () {
            ...
            return __generator(this, function (_b) {
                switch (_b.label) {
                    case 0:
                        ...
                        return [4 /*yield*/, pMap(this.textureSources, function (source) { return imageLoader.loadAsync(source); })];
                    case 1:
                        images = _b.sent();
                        ...
                        for (i = 0; i < images.length; i++) {
                            _a = indexToXZ(i, this.atlasWidth).toArray(), x = _a[0], y = _a[1];
                            context.drawImage(images[i], x * this.textureWidth, y * this.textureWidth);
                        }
                        return [2 /*return*/, new CanvasTexture(canvas, undefined, undefined, undefined, NearestFilter, NearestFilter)];
                }
            });
        });
    };
    TextureAtlas.prototype.getTextureUv = function (name) {
        ...
        var _a = indexToXZ(index, this.atlasWidth).toArray(), x = _a[0], y = _a[1];
